---
name: core-builder-fallback
description: Fallback Claude del core-builder de kelpie. Lo usa el PM cuando el builder de OpenCode+MiMo falla (auth, no compila dos veces, cita falsa o diff insatisfactorio).
