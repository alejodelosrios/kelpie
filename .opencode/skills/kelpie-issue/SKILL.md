---
name: kelpie-issue
description: Crea o corrige issues de kelpie con el formato que el enjambre exige (Contexto/Alcance/Criterios/Referencias/Skills) y sus labels. Úsala cuando el usuario pida crear un issue del roadmap de kelpie, redactar un issue nuevo, o auditar/arreglar un issue existente (#N) para que esté listo para el fleet.
---

# kelpie-issue — helper de issues

La entrada del usuario: descripción libre de lo que hay que crear, o `#N` para auditar/arreglar uno existente.
...
2. **Auditar `#N`**: léelo, señala qué falta contra el formato y ofrece el cuerpo corregido.
   ...
   fleet**, y lo que necesita es la skill `kelpie-research`, no un builder.
